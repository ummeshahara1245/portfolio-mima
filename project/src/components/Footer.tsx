      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <button onClick={() => scrollTo('home')} className="text-xl font-bold tracking-tight">
            <span className="text-[#38bdf8]">Mir</span>
        ...
        <div className="mt-8 pt-6 border-t border-white/5 text-center text-sm text-gray-500">
          Made with <Heart size={12} className="inline text-red-400 mx-1" /> by Mir Hussain &mdash; &copy; {new Date().getFullYear()} All rights reserved.
        </div>
      </div>
    </footer>
  );
